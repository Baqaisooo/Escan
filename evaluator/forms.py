...
# 'city_id', 'neighborhood_id', 'coordinator_note'
...
# 'owner_name', 'deed_number', 'deed_date', 'notary', 'outline_number', 'outline_name', 
# 'piece_number','area', 'license_number', 'license_date', 'dataEntry_note'